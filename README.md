...
Me chamo **Felipi**, tenho 20 anos e sou natural de **Campina Grande, Paraíba**. Atualmente sigo em constante evolução na área de tecnologia, com foco em desenvolvimento de software e construção de uma carreira sólida no setor.

Meu foco atual está no desenvolvimento **Front-End e Back-End**, estudando **JavaScript** e **Python**, com o objetivo de conquistar minha **primeira oportunidade em TI**, através de estágio ou vaga júnior.

Também estou aprimorando meu **inglês**, visando oportunidades internacionais e crescimento profissional no mercado global.
...
- E-mail: feelipi.net@gmail.com  
- Instagram: @henriques.dev  
- Discord: Henriques.dev
